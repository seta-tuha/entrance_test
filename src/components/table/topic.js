...
import { DeleteButton, DetailButton } from '../button';
...
const Topics = ({ topics, openModal, onSeeDetail, onDelete, classes }) => {
...
export default withModal(Confirm, withStyles(styles)(Topics));
